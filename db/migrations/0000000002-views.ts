...
const DROPPED = [
	"users_address_shipping",
	"orders_summary",
	"orders_items_agg",
	"cart_summary",
	"cart_lines",
	"products_summary",
	"products_variants_agg",
	"products_variants_labeled",
	"products_variants_options_resolved",
	"products_variants_sellable",
	"products_variants_priced",
	"products_variants_gallery",
	"products_gallery",
	"products_ratings",
	"products_stock",
	"products_cheapest",
