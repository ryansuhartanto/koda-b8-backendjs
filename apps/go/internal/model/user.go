...
// Birthdate is a DATE, kept as the text the database rendered so no timezone can
// shift the day. A comment on the field itself would become its schema description.
type UsersMe struct {
